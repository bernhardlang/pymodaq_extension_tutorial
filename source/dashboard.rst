...
Enter a value larger than zero onto the red value field of the shutter actuator, start continuous grabbing on the spectrometer and watch the displayed data switching between dark and illuminated signal as you click on the red and green arrows in the move's GUI to open and close the virtual shutter.
