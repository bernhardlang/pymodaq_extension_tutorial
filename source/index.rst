...
This tutorial guides through writing a PyMoDAQ extension starting from the templates provided by PyMoDAQ. From the point of view of the application, a (simulated) spectro-photometer is turned into an absorption spectrometer. Writing the corresponding plugin is covered for the sake of completeness. Advanced chapters treat incorporating configurator, sequencer and data mixer.
